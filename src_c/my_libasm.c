...
int main() {
    // char ptr1[100] = "hello world! this is a test";
    // char ptr2[] = "hello world! this is a test";
    char ptr3[100] = "hello world! this is a test";
    char *s1 = "hello world!";
    char *s2 = "hello world";
    ...
    // void * res_memcpy = asm_memcpy(ptr1, s3, n);
    // asm_memset(ptr2, c, n);
    asm_memmove(ptr3 + 10, ptr3, m);
